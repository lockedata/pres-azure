...
author: "Steph Locke @SteffLocke Locke Data"
date: '`r Sys.Date()`'
---
...
```{r eval=do_eval}
library(mrsdeploy)
remoteLogin("http://51.140.39.75:12800", 
            username = "admin", 
...
## Store a model for use in SQL Server
```{r eval=do_eval}
...
You can use a conenction to a DB, Hadoop, etc too
```{r eval=do_eval}
